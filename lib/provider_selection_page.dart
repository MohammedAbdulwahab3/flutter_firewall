...
// import 'package:flutter/material.dart';
// import 'models/dns_provider.dart' show DNSProvider, dnsProviders;
...
//   Widget build(BuildContext context) {
//     return Scaffold(
//       appBar: AppBar(title: const Text('Select DNS Provider')),
//       body: ListView.separated(
//         itemCount: dnsProviders.length,
//         separatorBuilder: (_, __) => const Divider(height: 1),
//         itemBuilder: (ctx, i) {
//           final p = dnsProviders[i];
//           return ListTile(
//             title: Text(p.name),
//             subtitle: Text(p.description.isNotEmpty ? p.description : p.type),
//             trailing: Text(p.type),
//             onTap: () => _onSelectProvider(p),
//           );
//         },
//       ),
//     );
...
//   void _onSelectProvider(DNSProvider provider) async {
//     // default toggle: true if type == 'Custom', otherwise false
//     bool useLocal = provider.type.toLowerCase() == 'custom';
...
//                   title: Text('Start with ${provider.name}?'),
//                   content: Column(
//                     mainAxisSize: MainAxisSize.min,
//                     children: [
//                       Row(
//                         children: [
//                           const Expanded(
//                             child: Text('Use local blocklist (custom)'),
//                           ),
//                           Switch(
//                             value: useLocal,
//                             onChanged: (v) => setSt(() => useLocal = v),
//                           ),
//                         ],
//                       ),
//                       const SizedBox(height: 8),
//                       Text(
//                         'If enabled the VPN will consult the custom blocklist you pushed from the app (Blocklist page / Import).',
...
//     if (res != null && res['provider'] != null) {
//       Navigator.pop(
//         context,
//         res,
//       ); // return a Map -> HomePage._goToSelection handles it
//     }
//   }
// }
// File: lib/provider_selection_page.dart
