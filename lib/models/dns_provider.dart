...
const DNSProvider nextDnsProvider = DNSProvider(
  ...
  dns: ['45.90.28.155', '45.90.30.155'],
  ipv6: ['2a07:a8c0::d5:9fff', '2a07:a8c1::d5:9fff'],
...
const List<DNSProvider> dnsProviders = [
  ...
  // === LOCAL GO DNS: corrected IP and DoH port to use 10.67.86.158:8053 ===
  DNSProvider(
    name: 'Local Go DNS',
    dns: ['10.67.86.158'],
    ipv6: null,
    features: ['Local test server', 'Blocklist via VPN'],
    description:
        'Your local Go DNS server (UDP/TCP on 10.67.86.158:8053, DoH at https://10.67.86.158:8053)',
    type: 'Local',
    doh: null,
  ),
