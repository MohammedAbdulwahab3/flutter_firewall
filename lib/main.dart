...
class _HomePageState extends State<HomePage> {
  ...
  String? _nextDnsProfileId = '775691';
  String? _nextDnsApiKey = '09bd3fb4279e2b396d3f2e0df922f76fcf1830bc';
  ...
  // Updated startVpn to accept explicit override flag
  Future<void> _startVpnForProvider({
    ...
    // If UI passed explicit override, use it. Otherwise default when provider.type == 'Custom'
  ...
  // Updated navigation / selection to accept Map result from ProviderSelectionPage
  ...
  //   if (result is DNSProvider) {
  //     chosen = result;
  //     useLocalFlag = null; // follow provider.type default
  //   } else if (result is Map) {
  //     chosen = result['provider'] as DNSProvider?;
  //     useLocalFlag = result['useLocalBlocklist'] as bool?;
  //   }
  ...
  //   setState(() => _selectedProvider = chosen);
  ...
  //       port1: mapping['port']!,
  //       port2: mapping['port']!,
  //       useLocalBlocklistOverride: useLocalFlag,
  //     );
  //   } else {
  //     // If not running we still record the selection and do not auto-start.
  //     // But if you want to auto-start immediately, uncomment below:
  //     // final mapping = _mapProviderToMethodAndPort(chosen);
  //     // await _startVpnForProvider(provider: chosen, queryMethod: mapping['method']!, port1: mapping['port']!, useLocalBlocklistOverride: useLocalFlag);
  //   }
  // }
          ...
          children: [
            ...
            ListTile(
              ...
              onTap: () {
                Navigator.push(
                  context,
                  MaterialPageRoute(builder: (_) => PerAppTabsPage()),
                );
              },
            ),
