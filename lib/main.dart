...
//       final args = <String, String>{'dns1': _selectedProvider!.dns[0]};
//       if (_selectedProvider!.dns.length > 1) {
//         args['dns2'] = _selectedProvider!.dns[1];
//       }
...
//       if (_isRunning) {
//         // restart tunnel to apply new DNS
//         await _toggleVpn();
//         await _toggleVpn();
//       }
//     }
...
//       await _toggleVpn(); // start with NextDNS
//     }
//   }
...
//               ),
//               onTap: () {
//                 // close the drawer, then open the block-domain dialog
...
// lib/main.dart (or lib/home_page.dart) - full HomePage + main
import 'dart:convert';
