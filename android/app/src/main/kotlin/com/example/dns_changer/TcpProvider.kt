...
//             mBlockFd = pipes[1]
//         } catch (e: Exception) {
//             Log.w("TcpProvider", "pipe failed: ${e.message}")
//         }
...
//                 } catch (e: Exception) {
//                     Log.w("TcpProvider", "poll error: ${e.message}")
//                 }

//                 if (blockFd.revents.toInt() != 0) {
//                     Log.i("TcpProvider", "Told to stop (blockFd)")
//                     running = false
//                     return
//                 }

//                 // Check upstream TCP sockets
...
//                         try {
//                             handleRawTcpResponse(w)
//                         } catch (e: Exception) {
//                             Log.w("TcpProvider", "handleRawTcpResponse: ${e.message}")
//                         } finally {
...
//                     }
//                 } catch (e: Exception) {
//                     Log.w("TcpProvider", "writeToDevice error: ${e.message}")
//                 }
...
//                     }
//                 } catch (e: Exception) {
//                     Log.w("TcpProvider", "readDevice error: ${e.message}")
//                 }
//             }
//         } finally {
...
//         try { Log.d("TcpProvider", "DNS TCP query for: ${question.name}") } catch (_: Exception) {}

//         if (service.resolveLocal(ip, dnsMsg)) return
//         if (shouldBlock(dnsMsg)) {
//             // craft NXDOMAIN reply preserving transaction id
//             try {
//                 val nx = raw.copyOf()
//                 val flags = 0x8003
...
//             } catch (e: Exception) {
//                 Log.w("TcpProvider", "craft NX failed: ${e.message}")
//             }
//             return
//         }

//         // send via TCP to upstream1:port1 (length-prefixed)
//         try {
//             val sock = Socket()
...
//                 Log.w("TcpProvider", "fromSocket failed: ${e.message}")
//                 return
//             }
...
//         } catch (e: Exception) {
//             Log.w("TcpProvider", "forward TCP error: ${e.message}")
//         }
//     }
...
//         } catch (e: Exception) {
//             Log.w("TcpProvider", "read tcp response: ${e.message}")
//         }
//     }
...
//                 list.add(wosp)
//             } catch (e: Exception) {
//                 Log.w("TcpProvider", "WospList.add: ${e.message}")
//             }
//         }
